...
:gameversion
echo THE CURRENT GAME VERSION IS 0.0.1
pause
cls
goto debug
...
if %cho%==4 goto exit
if %cho%==debug goto debug_mainmenu
cls
goto mainmenu
...
if %cho%==debug_mainmenu goto debug_mainmenu
if %cho%==debug_starttutorial goto debug_starttutorial
if %cho%==debug_declarewar goto debug_declarewar
if %cho%==debug_wintutorialwar goto debug_wintutorialwar
if %cho%==debug_startgame goto debug_startgame
if %cho%==debug_newgame goto debug_newgame
if %cho%== goto 
if %cho%== goto 
if %cho%== goto 
if %cho%== goto 
...
if %cho%==debug goto debug_starttutorial
goto starttutorial
...
if %cho%==debug goto debug_declarewar
goto declarewar
...
if %cho%==debug goto debug_wintutorialwar
goto wintutorialwar

:debug_wintutorialwar
cls
echo DEBUG CONSOLE:
set/p "cho=>"
...
if %cho%==debug goto debug_startgame
goto startgame
...
if %cho%==debug goto debug_newgame
goto newgame
...
if %cho%==2 goto no
	...
	echo Start a new game(1) or quit because you're a big baby!(2)
	set/p "cho=>"
	if %cho%==1 goto errorlevel
	if %cho%==2 goto mainmenu
	goto no
...
:errorlevel
cls
echo Welcome to the errorlevel!
pause
goto errorlevel